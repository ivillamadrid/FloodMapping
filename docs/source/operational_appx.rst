...
the training set up are discussed in detail, at this point the whole process has the following stages:

#. Selection of Imagery from selected scenarios and significant simulations, with the right number and impact.

#. Loading and required transformations to be processed with Pytorch libraries.
